    ...
    <Tabs defaultValue="overview" className="space-y-6">
      <div className="flex items-center justify-between print:hidden">
        <TabsList>
          ...
          <TabsTrigger value="release">Release Overview</TabsTrigger>
        </TabsList>
        <Button
          variant="outline"
          size="sm"
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {data.acceptedRate.toFixed(1)}% approval rate
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Avg Strategic Score</CardTitle>
              <TrendingUp className="h-4 w-4 text-blue-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{data.avgScore.overall.toFixed(1)}</div>
              <p className="text-xs text-muted-foreground">
                Across {data.totalER} requests
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Decision Velocity</CardTitle>
